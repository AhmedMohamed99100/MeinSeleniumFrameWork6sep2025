...
public class PurchaseBackPackTest {
    WebDriver driver;
    LoginPage LP;
    CartPage CartP;
    CheckOutpage CheckP;
    ...
    public void SeUP(String browser) throws IOException {
        ...
        takeScreenshot("Startseite"); // Screenshot direkt nach Seitenöffnung
    }
    ...
    public void SaucDemoTC1() throws InterruptedException {
        try {
            ...
            Thread.sleep(3000);
            takeScreenshot("Checkout_Seite"); // Screenshot Checkout-Seite
            ...
            Thread.sleep(3000);
            takeScreenshot("Übersichtsseite"); // Screenshot Übersicht nach Finish klicken
